...
Keep Starlight's default visual system unless a concrete reader need justifies a local override. Borrow principles from strong documentation products such as OpenAI Learn—clear information hierarchy, calm reading rhythm, purposeful navigation, and selective interactive examples—without cloning their brand, DOM, or technology stack.

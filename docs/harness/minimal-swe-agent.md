...
| **Reasoning**                                                                                                                                 | [model](https://www.aihero.dev/ai-coding-dictionary/model) 推理(CoT / reasoning tokens / [effort](https://www.aihero.dev/ai-coding-dictionary/effort))                                                             | ⚠️ 依赖 [model](https://www.aihero.dev/ai-coding-dictionary/model) 自身           | Responses 支持 `reasoning.effort`,本实现暂未启用                                                                                       |
...
| **[memory system](https://www.aihero.dev/ai-coding-dictionary/memory-system)**                                                                | 跨 [turn](https://www.aihero.dev/ai-coding-dictionary/turn)/[session](https://www.aihero.dev/ai-coding-dictionary/session) 的状态保留                                                                              | ❌ 无持久化                                                                       | [context](https://www.aihero.dev/ai-coding-dictionary/context) 即记忆,随 `max_turns` 截断                                              |
...
- [memory system](https://www.aihero.dev/ai-coding-dictionary/memory-system)(跨 [session](https://www.aihero.dev/ai-coding-dictionary/session)) — 对应 **[memory system](https://www.aihero.dev/ai-coding-dictionary/memory-system) / [context](https://www.aihero.dev/ai-coding-dictionary/context) 管理**
...
**[memory system](https://www.aihero.dev/ai-coding-dictionary/memory-system)** 指 [agent](https://www.aihero.dev/ai-coding-dictionary/agent) 在多次交互或多次运行之间保留并复用信息。OpenAI 工程上区分两层:**短期记忆**由 Sessions 承担,自动在多轮间维护对话历史;**[memory system](https://www.aihero.dev/ai-coding-dictionary/memory-system)**则把历次运行中提炼出的偏好、约束记为「记忆笔记」,供未来运行复用,与 [session](https://www.aihero.dev/ai-coding-dictionary/session) 级消息历史相互独立。(来源:OpenAI Agents SDK Sessions / [memory system](https://www.aihero.dev/ai-coding-dictionary/memory-system) 文档。以 OpenAI「[session](https://www.aihero.dev/ai-coding-dictionary/session) 级短期记忆 vs 跨运行[memory system](https://www.aihero.dev/ai-coding-dictionary/memory-system)」的区分为准;本仓库无持久记忆,[context](https://www.aihero.dev/ai-coding-dictionary/context) 即记忆,随 `max_turns` 截断。)
...
把两个 minimal 实现与两个工业级 [agent](https://www.aihero.dev/ai-coding-dictionary/agent) 并排,一页看清各自的取舍(详见 [openai.md](openai.md) / [anthropic.md](anthropic.md)):

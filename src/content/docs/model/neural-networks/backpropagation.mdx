...
import BackpropagationGraphFigure from '@/components/deep-learning-figures/BackpropagationGraphFigure.astro';
...
下一步建议读 [GPT 是什么？直观讲解 Transformer](../gpt-transformer/)。Transformer 的 [training](https://www.aihero.dev/ai-coding-dictionary/training) 依然依赖反向传播，但它的 [model](https://www.aihero.dev/ai-coding-dictionary/model) 结构会把注意力、残差连接、LayerNorm 和 MLP 组合起来。
